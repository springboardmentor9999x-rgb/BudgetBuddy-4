...
import { FaCheckCircle, FaExclamationTriangle, FaPlus, FaTrashAlt, FaWallet } from "react-icons/fa";
import { createBudget, deleteBudget, getBudgetSummary } from "../services/budgetService";
import "./Budget.css";
...
function Budget() {
  ...
  return <div className="budget-page">
    ...
    <header className="budget-header">
      <div><p className="budget-eyebrow">Spending plans</p><h1>Plan your month with confidence</h1><span>Set clear category limits and see exactly where your money is going.</span></div>
      <label className="budget-month">Viewing month<input aria-label="Budget month" type="month" value={month} onChange={(event) => setMonth(event.target.value)} /></label>
    </header>
